...
# Author-local Ensembl annotation (not shipped in the repo). Override with the
# ENSEMBL_GTF environment variable to point at your own filtered GTF.
gtf_path = os.environ.get(
    'ENSEMBL_GTF',
    '/Users/brendanmiller/Library/CloudStorage/Box-Box/post_shortstop_processing/annotation/ensemlb_hg38_filtered.gtf',
)
