...
# Optional second copy for the manuscript supplement (disabled by default).
# Set SUPPLEMENT_DIR to enable, e.g. os.environ.get('SUPPLEMENT_DIR', 'supplementary').
# outdir_supplement = os.environ.get('SUPPLEMENT_DIR', 'supplementary')
