...
tmt_meta_file = file.path(TMT_DIR, "rosmap_metadata/combine_rounds_metadata.csv")
clinical_file = file.path(TMT_DIR, "rosmap_metadata/custom_dx_for_analyses.csv")
tmt_quant_file = file.path(TMT_DIR, 'shortstop_proteogenomics_appended_results/C2.median_polish_corrected_log2abundanceRatioCenteredOnMedianOfBatchMediansPerProtein_SHORTSTOP_AND_PROTEO_COMBINEDROUNDS.csv')
...
write.csv(results_fit, file.path(TMT_DIR, "regressed_out_covariates_TMT_microproteins_shortstop_and_proteo_combined_rounds_PCAcorrected.csv"))
