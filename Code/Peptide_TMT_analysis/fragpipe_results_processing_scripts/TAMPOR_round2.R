...
# NORMALIZE RAW DATA
dat <- read.csv('/Users/brendanmiller/Library/CloudStorage/Box-Box/brain_smorfs/tmt/shortstop_proteogenomics_appended_results/round2/shortstop_proteogenomics_appended_raw_no_correction_intensity.csv')
# Set $X to rownames
rownames(dat) <- dat$X
# Remove $X
dat <- dat[, -1]
...
datadir <- "/Users/brendanmiller/Library/CloudStorage/Box-Box/brain_smorfs/tmt/shortstop_proteogenomics_appended_results/round2/"
numericMeta<-read.csv(file=paste0("/Users/brendanmiller/Library/CloudStorage/Box-Box/brain_smorfs/tmt/rosmap_metadata/rosmap_round2_specimen_metadata_for_batch_correction.csv"),row.names=1,header=TRUE)
